...
if (function (a) {
    ...
    if (0 === b.length) window.spritz_sdk_root = "//sdk.spritzinc.com/js/1.0";
        ...
        if (d.length < 3) e = ".";
            ...
            for (var f = 0; f < d.length - 2; f++) e += d[f], e += "/";
...
var jsutil = jsutil || function () {
    ...
    return a.prototype.setValue = function (a, c) {
        ...
        b(".btn-group[data-role='select']").each(function () {
            var c = b(this);
            c.data("controller") instanceof a || new SPRITZ.component.BootstrapSelectController(c)
        })
    }), {
    ...
    this.getWords = function () {
        ...
        var d = a;
        if (b > 0)
            for (; d > 0 && b > 0 && (!f[d].isSentenceStart() || 0 != --b); d--);
        return d
        ...
        var d = a;
        if (b > 0)
            for (; d < f.length && (!f[d].isSentenceStart() || 0 != --b); d++);
        return d
    ...
    ib(), this.getCurrentText = function () {
        ...
        J == d.running ? (D ? jsutil.debug(4, c + "Pausing text with " + D.size() + " words at word # " + (D.getCurrentIndex() + 1)) : jsutil.debug(4, c + "No text to pause"), null != G && (clearTimeout(G), G = null), D.getCurrentIndex() > 0 && D.setCurrentIndex(D.getCurrentIndex()), J = d.paused) : J = d.paused
    }, this.resumeText = function () {
        D ? D.hasNextWord() ? (jsutil.debug(4, c + "Resuming text with " + D.size() + " words at word # " + (D.getCurrentIndex() + 1)), J = d.running, e(), Ab(), nb(), sb()) : jsutil.debug(4, c + "Cannot resume Text because there are no more words") : jsutil.debug(2, c + "Cannot resume Text because it is null")
    ...
    var a = {
        name: "Spritz_JSSDK",
        version: "1.0.5",
        buildDate: "Thu Apr 10 2014 16:54:54 GMT-0600 (MDT)"
    };
    return {
        VersionInfo: a
    }
    ...
    function b(a, b, c) {
        this.url = b + "/oauth/authorize?c=" + encodeURIComponent(SPRITZ.client.VersionInfo.name + "_" + SPRITZ.client.VersionInfo.version) + "&response_type=token&client_id=" + a + "&redirect_uri=" + encodeURIComponent(c), this.onSuccess = null, this.onError = null
    }
    var c = function (a) {
    ...
    return b.prototype.show = function (a, b) {
        this.onSuccess = a, this.onError = b, "object" == typeof console && console.log("opening auth popup with URL: ", this.url), "undefined" == typeof localStorage && localStorage.removeItem("spritz.authResponse");
        var d = window.open(this.url, "SpritzLogin", "width=400,height=400,location=0,menubar=0,toolbar=0");
        if (d) {
            d.focus(), this.showing = !0, this.onMessageHandler = jsutil.createDelegate(this, c), "function" == typeof window.addEventListener ? (window.addEventListener("message", this.onMessageHandler, !1), "object" == typeof console && console.log("Registered listener via addEventListener")) : window.attachEvent("onmessage", this.onMessageHandler);
            var e = this,
                f = null;
        ...
        } else alert("Please enable popups to use Spritz."), this.onError && this.onError(new Error("Popup unable to open."))
    }, {
        APIError: a,
        AuthPopup: b
    }
    ...
    var a = jQuery,
        b = function (a, b) {
            ...
            g.call(this, {
                type: "GET",
                url: this.apiRoot + "/contentVersion?includePlainText=false&sortColumn=createdDate&sortDirection=DESC&pageSize=1&contentId=" + encodeURIComponent(a),
                dataType: "json",
                async: !0
            ...
            if (this.clientAccessToken = a, null === a) o.call(this, "client");
            else try {
                p.call(this, "client", a)
            } catch (b) {
                console && console.log("Error with localStorage: ", b)
            }
        }, s = function (a) {
            if (this.userAccessToken = a, null === a) o.call(this, "user");
            else try {
                p.call(this, "user", a)
            } catch (b) {
                console && console.log("Error with localStorage: ", b)
    ...
    if ("SpritzSettings" in window && "object" == typeof window.SpritzSettings)
        if (window.SpritzSettings.hasOwnProperty("clientId")) {
    ...
    function c() {
        if (null !== this.spritzClient && !this.loading) {
            var a = this.parentContainer.data("url");
            (null === a || "undefined" == typeof a) && (a = location.href), a.length > 0 && (this.loading = !0, this.pausePlayBtn.addClass("btn-disabled"), F("#spritzer-loading").show(), this.spritzClient.fetchContents(a, jsutil.createDelegate(this, d), jsutil.createDelegate(this, e)))
        }
    }
    ...
    function j() {
        null == this.spritzPanel.getCurrentText() ? c.call(this) : x(this.pausePlayBtn) && this.spritzPanel.getCurrentText().hasNextWord() ? this.spritzPanel.isPaused() || this.spritzPanel.isReady() ? (this.spritzPanel.resumeText(), v.call(this, !0), w.call(this, !1), r.call(this, this.playTitle)) : (this.spritzPanel.pauseText(), v.call(this), w.call(this, !0), r.call(this, this.pauseTitle)) : (this.spritzPanel.goToFirstWord(), this.spritzPanel.resumeText(), v.call(this, !0), w.call(this, !1), r.call(this, this.playTitle))
    }
    ...
    return a.prototype.attach = function (a) {
        this.parentContainer = a, a.hasClass("spritzer") || a.addClass("spritzer"), this.container.appendTo(a), a.data("controller", this), null !== this.spritzClient && this.hasSource() && (w.call(this, !0), this.pausePlayBtn.removeClass("btn-disabled"))
    }, a.prototype.detach = function () {
        this.container.detach()
    }, a.prototype.hasSource = function () {
        var a;
        if (null === this.spritzPanel.getCurrentText()) {
            var b = this.parentContainer.data("url");
            a = null === b || "undefined" == typeof b || b.length > 0
        } else a = !0;
        return a
    }, a.prototype.setSpritzText = function (a) {
        this.spritzPanel.resetText(), null === a ? (v.call(this, !1), null != this.spritzClient && this.hasSource() && (w.call(this, !1), this.pausePlayBtn.removeClass("btn-disabled"))) : (null == a.getProgressTracker() && a.setProgressTracker(this.progressReporter), this.spritzPanel.setCurrentText(a), this.spritzPanel.setOnCompleteCallback(jsutil.createDelegate(this, k)), v.call(this, !1))
    }, a.prototype.getUrl = function () {
        return this.parentContainer.data("url")
    }, a.prototype.setUrl = function (a) {
        this.parentContainer.data("url") === a || (this.spritzPanel.resetText(), this.parentContainer.data("url", a), v.call(this, !1), null !== this.spritzClient && this.hasSource() && (w.call(this, !0), this.pausePlayBtn.removeClass("btn-disabled")))
